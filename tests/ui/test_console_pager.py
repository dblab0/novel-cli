...
from novel_cli.ui.shell.console import _NovelPager, console
...
class TestConsolePagerIgnoresManpager:
    ...
    def test_pager_context_uses_novel_pager_by_default(self):
    ...
    def test_manpager_stripped_during_pydoc_pager(self):
        """When MANPAGER is set, _NovelPager must strip it before calling pydoc.pager()."""
        pager = _NovelPager()
