...
from novel_cli.soul.slash import plan
...
async def _run_plan(soul: NovelSoul, args: str) -> None:
...
class TestPlanSlashCommand:
    async def test_plan_on(
        ...
        sent: list[TextPart] = []
        monkeypatch.setattr("novel_cli.soul.slash.wire_send", lambda msg: sent.append(msg))
