...
from novel_cli.soul.compaction import CompactionResult, SimpleCompaction, should_auto_compact
from novel_cli.wire.types import TextPart, ThinkPart
...
def test_prepare_only_keeps_text_parts_in_compaction():
    ...
    Fixes: https://github.com/MoonshotAI/novel-cli/issues/1395
    Fixes: https://github.com/MoonshotAI/novel-cli/issues/1390
    """
    messages = [
        Message(
            role="user",
