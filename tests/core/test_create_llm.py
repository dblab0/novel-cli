...
from novel_cli.config import LLMModel, LLMProvider
from novel_cli.llm import augment_provider_with_env_vars, create_llm
...
def test_augment_provider_with_env_vars_kimi(monkeypatch):
    ...
    monkeypatch.setenv("NOVEL_BASE_URL", "https://env.test/v1")
    monkeypatch.setenv("NOVEL_API_KEY", "env-key")
    monkeypatch.setenv("NOVEL_MODEL_NAME", "kimi-env-model")
    monkeypatch.setenv("NOVEL_MODEL_MAX_CONTEXT_SIZE", "8192")
    monkeypatch.setenv("NOVEL_MODEL_CAPABILITIES", "Image_In,THINKING,unknown")
...
def test_create_llm_kimi_model_parameters(monkeypatch):
    ...
    monkeypatch.setenv("NOVEL_MODEL_TEMPERATURE", "0.2")
    monkeypatch.setenv("NOVEL_MODEL_TOP_P", "0.8")
    monkeypatch.setenv("NOVEL_MODEL_MAX_TOKENS", "1234")
