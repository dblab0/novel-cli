...
from novel_cli.wire.file import WireFileMetadata, WireMessageRecord
from novel_cli.wire.protocol import WIRE_PROTOCOL_VERSION
from novel_cli.wire.types import TextPart, TurnBegin
...
async def test_custom_title_overrides_wire_title(isolated_share_dir: Path, work_dir: KaosPath):
    ...
    from novel_cli.session_state import save_session_state
...
async def test_save_state_preserves_in_memory_todos(isolated_share_dir: Path, work_dir: KaosPath):
    ...
    from novel_cli.session_state import TodoItemState, load_session_state
