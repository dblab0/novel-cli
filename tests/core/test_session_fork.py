"""Tests for novel_cli.session_fork module."""
...
from novel_cli.session_fork import (
    TurnInfo,
    _extract_user_text,
...
from novel_cli.wire.file import WireFileMetadata, WireMessageRecord  # noqa: I001
from novel_cli.wire.protocol import WIRE_PROTOCOL_VERSION
from novel_cli.wire.types import TextPart, TurnBegin, TurnEnd
