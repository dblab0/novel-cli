...
from novel_cli.ui.shell.prompt import PromptMode, UserInput
from novel_cli.wire.types import ApprovalRequest, StatusUpdate, SteerInput, TextPart

shell_visualize = importlib.import_module("novel_cli.ui.shell.visualize")
...
def _make_two_question_request():
    ...
    from novel_cli.wire.types import QuestionItem, QuestionOption
    from novel_cli.wire.types import QuestionRequest as QR
