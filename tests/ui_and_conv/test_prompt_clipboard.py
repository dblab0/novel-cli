...
from novel_cli.ui.shell.prompt import PromptMode
from novel_cli.utils.clipboard import ClipboardResult
...
async def test_question_delegate_expands_placeholders_on_submit() -> None:
    ...
    from novel_cli.ui.shell.question_panel import QuestionPromptDelegate, QuestionRequestPanel
    from novel_cli.wire.types import QuestionItem, QuestionRequest
