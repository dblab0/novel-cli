...
from novel_cli.wire.types import ApprovalRequest, ApprovalResponse, QuestionRequest, StatusUpdate
...
async def test_shell_external_approval_response_syncs_modal(
    ...
    soul = NovelSoul(agent, context=Context(file_backend=tmp_path / "h.jsonl"))
    shell = Shell(soul)
