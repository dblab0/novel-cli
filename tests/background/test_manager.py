...
from novel_cli.approval_runtime import ApprovalRequestRecord, ApprovalRuntimeEvent, ApprovalSource
from novel_cli.background import TaskRuntime, TaskSpec
from novel_cli.background.agent_runner import BackgroundAgentRunner
from novel_cli.notifications import NotificationDelivery, NotificationEvent, NotificationView
...
async def test_create_agent_task_persists_starting_state(runtime, monkeypatch):
    ...
    monkeypatch.setattr("novel_cli.background.agent_runner.BackgroundAgentRunner.run", _noop)
