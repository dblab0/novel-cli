...
所有面向 UI 的颜色定义都集中在此模块中，使得在深色和浅色终端主题之间切换
只需更改活动的 ``ThemeName`` 即可。
"""
...
# ---------------------------------------------------------------------------
# Diff 颜色（用于 utils/rich/diff_render.py）
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 任务浏览器颜色（用于 ui/shell/task_browser.py）
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 提示符/补全菜单颜色（用于 ui/shell/prompt.py）
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 底部工具栏片段颜色（用于 ui/shell/prompt.py）
# ---------------------------------------------------------------------------
...
class ToolbarColors:
    ...
    Attributes:
        separator: 分隔符颜色。
        yolo_label: YOLO 模式标签颜色。
        plan_label: 计划模式标签颜色。
        plan_prompt: 计划模式提示颜色。
        cwd: 当前工作目录颜色。
        bg_tasks: 后台任务颜色。
        tip: 提示文本颜色。
    """
...
# ---------------------------------------------------------------------------
# MCP 状态提示颜色（用于 ui/shell/mcp_status.py）
# ---------------------------------------------------------------------------
