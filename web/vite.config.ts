...
function readNovelCliVersion(): string {
  const fallback = process.env.NOVEL_CLI_VERSION ?? "dev";
...
const novelCliVersion = readNovelCliVersion();
...
export default defineConfig({
  ...
  define: {
    __NOVEL_CLI_VERSION__: JSON.stringify(novelCliVersion),
  },
  resolve: {
    alias: {
